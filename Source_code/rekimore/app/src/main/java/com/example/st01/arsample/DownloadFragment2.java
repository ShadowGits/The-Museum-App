...
public class DownloadFragment2 extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        File pa = new File("/sdcard/Download/video/"+res_model+".mp4");
        if (!pa.exists()) {
            mTask = new DownloadTask();
            mTask.execute("https://s3.amazonaws.com/myhelenbucket/"+res_model+".mp4",
                    "/sdcard/Download/video/" +res_model+".mp4");
        }
    }
