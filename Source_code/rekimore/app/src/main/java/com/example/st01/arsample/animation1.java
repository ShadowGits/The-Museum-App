...
public class animation1 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String SrcPath = "/sdcard/Download/video/"+res_model+".mp4";
        myVideoView.setVideoPath(SrcPath);
        myVideoView.setMediaController(new MediaController(animation1.this));
        ...
        myVideoView.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                File dir1 = new File("/sdcard/download/video/"+res_model+".mp4");
                DeleteRecursive(dir1);
                new Timer().schedule(new TimerTask() {
                    @Override
                    public void run() {

                        Intent k = new Intent (animation1.this,ExampleLoadObjFile.class);
                        startActivity(k);
                    }
                },1000);
            }
